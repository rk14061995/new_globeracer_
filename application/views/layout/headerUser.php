              ...
              <div class="input-group ">
                ...
                <div class="input-group-append">
                    <div class="input-group-text">
                     My Team: 
                        <span class="float-left text-left px-5 font-weight-bold">
                            <?php
                                $userTable_id=$userSessionData[0]->id_table;
                                $regDetails=$this->db->where('user_id',$userTable_id)->get('race_registeration')->result();
                                // echo count($regDetails);
                                if(count($regDetails)>0){
                                    $teamDetails=$this->db->where('team_id',$regDetails[0]->team_id)->get('team_details')->row();
                                    if($teamDetails){
                                         echo $teamDetails->team_name;
                                    }else{
                                        echo ' No Team Updated ';
                                    }
                                    // try{
                                        //
                                    // }
...
<!--              </li> -->
              ...
              <li class="nav-item btn-rotate dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <?php 
                  $useDetails_=$this->db->where('id_table',$userTable_id)->get('user_details')->row();
                      if($useDetails_->sign_up_type=='Google'){
